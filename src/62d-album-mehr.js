...
const ALBUM_FRAGEN = [
  ...
  'Welche Lüge erzählt {du} sich jeden Morgen?',
  ...
  'Wofür hat {du} sich zuletzt geschämt?',
  ...
  'Was liegt in der Schublade, die {du} niemandem zeigt?',
  ...
  'Wie sieht es bei {du} aus, wenn Besuch kommt — und wie sonst?',
  'Was war der erste echte Verlust?',
  'Welche Berührung erträgt {du} nicht?',
  'Was hat {du} sich vorgenommen und nie getan?',
  'Bei wem würde {du} sich entschuldigen, wenn es leicht wäre?',
  'Wie klingt {du}s Lachen — und wann ist es echt?',
  'Was besitzt {du}, das älter ist als {du} selbst?',
  ...
  'Was hat {du} sich abgewöhnt und vermisst es doch?',
  'Wen würde {du} verteidigen, auch wenn es falsch wäre?',
  'Wie geht {du} mit Warten um?',
  'Was ist {du}s liebste Uhrzeit?',
  ...
  'Welche Tageszeit gehört {du} allein?',
  'Was würde {du} retten, wenn man nur eines retten darf?',
  'Was tut {du} mit einem Brief, den {du} nicht öffnen will?',
  'Welches Versprechen hat {du} gebrochen?',
  'Was macht {du} mit den Händen, wenn {du} lügt?',
  'Woran merkt {du} selbst, dass es zu viel wird?'
];
