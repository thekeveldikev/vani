...
const ANLEITUNG = [
  ...
  },
  {
    ...
    abschnitte: [
      ...
      { t: 'Die Stickerkiste', p: ['Beim Zeichnen ist „Auch in die Stickerkiste legen" angehakt. Beim nächsten Sticker-Symbol zeigt VANI erst die Kiste: Antippen klebt ihn wieder auf, lange drücken nimmt ihn heraus, „Neuen zeichnen" öffnet den Block. Ein schon aufgeklebter Sticker kommt per langem Halten nachträglich in die Kiste („In die Stickerkiste legen") oder gleich noch einmal auf die Seite („Noch einmal aufkleben").'] },
      { t: 'Kritzeln', p: [
