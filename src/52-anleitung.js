...
const ANLEITUNG = [
  ...
  },
  {
    ...
    abschnitte: [
      ...
      { t: 'Leuchter, Uhr und der zweite Stuhl', p: ['Der Leuchter brennt wirklich ab: Jede Kerze, die ich im Schreibraum anzünde, nimmt den sieben Kerzen etwas Wachs — nach zwanzig Schreibstunden sind sie herunter, dann „neue aufstecken“ als kleines Ritual. Die Standuhr zeigt die Zeit, antippen sagt, wie lange ich schon am Tisch sitze; wer mag, lässt sie ticken (Einrichten), zur vollen Stunde ein leiser Glockenschlag. Der zweite Stuhl ist der Faden — ein Gespräch am Tisch.'] },
