...
const ANLEITUNG = [
  ...
  {
    id: 'schreibtisch', titel: 'Der Schreibtisch', icon: 'schreibtisch', raum: 'schreibtisch',
    kurz: 'Ein schwerer Tisch vor dem Nachtfenster — alles darauf tut etwas.',
    abschnitte: [
      { t: 'Was das ist', p: ['Kein Raum zum Einsortieren, sondern der Mittelpunkt. Dunkles Holz, eine Lampe mit bernsteinfarbenem Kegel (kein Deckenlicht, niemals), ein siebenarmiger Leuchter, das Fenster auf den verwilderten Garten bei Nacht, mit echter Mondphase. Nichts darauf ist Dekoration: jedes Ding ist ein Griff in mein Schreiben.'] },
      { t: 'Die Lampe', p: ['Am Knauf der Zugschnur ziehen — nach unten, zur Seite, schräg, wohin die Hand will; die Schnur folgt, dehnt sich, bekommt einen Bauch, und schnappt beim Loslassen zurück. Ist sie weit genug gezogen, schaltet die Lampe an oder aus — das Licht schmilzt ein wie ein Glühfaden, nicht wie ein Schalter; der Schirm zuckt kurz. Im Kegel treibt Staub, im Sommer verirrt sich nachts ab und zu eine Motte ums Licht. Der Blick wandert leicht mit der Maus: der Garten hinten bewegt sich anders als der Tisch vorn. Ist sie aus, bleibt nur der Schein der Kerzen. Auf den Schirm tippen: heller oder dunkler in Stufen. Das Fenster weiß außerdem, wie spät es ist: Dämmerung am frühen Abend, tiefe Nacht, erstes Grau vor sechs, und ein grauer Tag — der Tisch bleibt ein Nachttisch, aber der Himmel lügt nicht. Und er kennt die Jahreszeit: Glühwürmchen im Sommer, fallende Blätter im Herbst, Schnee und kahle Bäume im Winter, Blüten im Frühling.'] },
      { t: 'Leuchter, Uhr und der zweite Stuhl', p: ['Der Leuchter brennt wirklich ab: Jede Kerze, die ich im Schreibraum anzünde, nimmt den sieben Kerzen etwas Wachs — nach zwanzig Schreibstunden sind sie herunter, dann „neue aufstecken“ als kleines Ritual. Die Standuhr zeigt die Zeit, antippen sagt, wie lange ich schon am Tisch sitze; wer mag, lässt sie ticken (Einrichten) — eine echte Aufnahme einer Standuhr, leise und in sauberer Schleife, und zur vollen Stunde ein Glockenschlag. Das Ticken hängt am Lautstärkeregler und hört auf, sobald der Tisch nicht mehr zu sehen ist. Der zweite Stuhl ist der Faden — ein Gespräch am Tisch.'] },
      { t: 'Der Papierkorb unterm Tisch', p: ['Links unten, mit zerknüllten Blättern: der Papierkorb. Antippen zeigt, was zuletzt hineinflog; eines „glätten“ holt es zurück — an seinen alten Ort.'] },
      { t: 'Die Dinge', p: ['Die Manuskripte in der Mitte sind meine drei zuletzt bearbeiteten Texte — antippen schreibt weiter. Tintenfass und Feder: ein neues Blatt. Die Tasse: der Schreibtag (sie dampft, wenn ich heute geschrieben habe; die Zahl sind die Wörter). Das Glas mit dem Fundstück: der Funke des Tages. Der Brief: eine Zeitkapsel an mich selbst. Die Karteikarten: eine Wortkiste abfragen. Die Lupe: suchen. Der Bleistiftstummel: schnell einen Schnipsel. Das Notizbuch mit den Zetteln: mein letztes Heft. Der Bücherstapel: der Lesestapel. Die Lampe: heller oder dunkler. Der Leuchter: Schreibzeit anzünden — öffnet ein Blatt und die Kerze brennt. Das Fenster: die Grillen und der Wind des Nachtgartens (Klang); spielt im Klangraum Regen, regnet es vor dem Fenster, bei Gewitter wetterleuchtet es.'] },
      { t: 'Der Kalender', p: ['Links auf dem Tisch, etwas über dem Briefumschlag, liegt ein Kalender. Ein Tipp schlägt ihn auf. Vier Ansichten: Monat (Tag für Tag), Jahr (alle zwölf Monate auf einen Blick), Leben (ein Strich pro Mensch, mit Kerben für die Ereignisse) und Chronik (alles der Reihe nach).', 'Ein Termin braucht nur ein Datum. Alles andere — Art, Titel, Notiz, Ort, wer dabei war, Zeichen und Farbe — darf leer bleiben. Die Namen bei „Wer“ sind frei hineingeschrieben: der Kalender hängt nicht an deinen Figuren und deinen Texten, du kannst eintragen, was du willst.'] },
      { t: 'Wie weit der Kalender reicht', p: ['Von 1600 bis 2050. Gezeigt wird er ab 2000 — vierhundert Jahresknöpfe wären keine Leiste mehr, sondern eine Wand. Steht wirklich etwas früher darin, reicht die Leiste von allein bis dorthin; sonst klappt „‹ früher“ sie Schritt für Schritt weiter auf.', 'So kannst du auch eine Figur eintragen, die 1783 geboren wurde — mit richtigem Alter und richtigem Lebensband.'] },
      { t: 'Jahrestage und Widersprüche', p: ['Ein Geburtstag kehrt jedes Jahr wieder — bis zum Todestag, dann nicht mehr. Und wenn etwas nicht sein kann — gestorben vor der Geburt, zwei Geburtsdaten für dieselbe Person —, sagt der Kalender es ruhig dazu, ohne zu meckern.'] },
      { t: 'Die Schublade', p: ['Unten am Tisch. Darin: drei Fundstücke aus meinen eigenen Texten (wie auf dem Zuhause, nur verstaut), eine winzige Lupe, Bindfaden (Cluster), getrocknete Blätter (die losen Blätter), Briefmarken (etwas hinausschicken), ein Schlüssel ohne Schloss (Feinheiten) — und ein Stück Metall unbekannter Herkunft: ein alter Schnipsel, der entweder bedeutungslos ist oder der Schlüssel zu einem ganzen Roman.'] },
      { t: 'Brief an mich', p: ['Ich schreibe, wähle „in einem Monat“ (oder einer Woche, einem Jahr) — der Brief wird versiegelt und liegt auf dem Tisch. Vor dem Datum lässt er sich nicht öffnen. Ist es so weit, pocht das Siegel. Öffnen, lesen, antworten (wird ein neues Blatt) oder wegwerfen.'], b: 'Am Anfang eines Projekts einen Brief „in drei Monaten“: was ich hoffe, was ich fürchte, wo ich stehen will.' },
      { t: 'Das Bücherbord und die Cover', p: ['Die Bücher stehen in einer Reihe auf einem Brett, leicht gelehnt, jedes für sich greifbar — Darüberfahren hebt eines heraus, ein rotes Leseband zeigt, wie weit ich bin. Cover holt VANI aus dem Netz über die ISBN (aus dem Impressum der PDF oder dem Koffer): beim Auflegen still im Hintergrund, für alles schon Aufgelegte mit „Schöne Cover holen“ im Lesestapel, je Buch mit „Cover aus dem Netz (ISBN)“ — notfalls tippe ich die ISBN selbst.'] },
      { t: 'Der Lesestapel', p: ['Bücher als PDF auf dem Tisch — sie liegen nur auf meinen Geräten und reisen verschlüsselt über den privaten Bereich, nie übers Netz, nie ins Repo. Das Cover malt VANI aus der ersten Seite (oder ich wähle eine andere). Antippen schlägt auf; lange halten: umbenennen, Cover, von vorn, vom Tisch nehmen.'] },
      { t: 'Der Bücherkoffer', p: ['Liegt neben der App ein verschlüsselter Bücherkoffer, fragt „Aus dem Bücherkoffer (Passwort)“ nach dem Passwort und legt die Bücher auf den Tisch — ohne Dateiauswahl, ohne Netz danach. Die Dateien im Koffer sind ohne Passwort Rauschen. Das Werkzeug dazu: `node werkzeug/buecherkoffer.mjs <Ordner>`.'] },
      { t: 'Bücher auflegen — drei Wege', s: ['„PDF auflegen“ wählt Dateien — am Laptop, am Handy, überall, wo das Gerät Dateien öffnen darf.', 'Auf dem Schul-iPad: Bücher, die schon im Goodnotes-Archiv liegen, mit „Aus dem Goodnotes-Archiv“ aufs Lesepult — oder am Handy auflegen, der private Bereich bringt sie aufs iPad.', 'In der Desktop-App: „Aus dem Bücherordner“ — alles, was in „Dokumente/VANI-Bücher“ oder im Ordner „buecher“ neben der App liegt, mit einem Griff.'] },
      { t: 'Randnotizen, Suche, Vorlesen', p: ['Oben im Lesemodus: die Stecknadel legt Randnotizen zu dieser Seite an (so viele ich will; ein Punkt am Knopf zeigt, dass hier welche liegen; „Alle Notizen“ springt durch das Buch), die Lupe sucht im ganzen Buch (Textebene, Treffer mit Ausschnitt, antippen springt hin), das Vorlese-Symbol liest die Seite mit der Stimme des Geräts. Lesezeichen haben Farben. Der Lesestapel zeigt je Buch, wie viele Seiten ich heute, gestern, diese Woche gelesen habe; auf dem Zuhause steht „Weiterlesen“, wenn ich ein Buch in den letzten zwei Wochen angefasst habe.'] },
      { t: 'Der Lesemodus', p: ['Wie in einem Lesegerät: Tippen rechts blättert vor, links zurück, Mitte zeigt die Leisten; Wischen geht auch, am Laptop die Pfeiltasten (Leertaste vor, Pos1/Ende). Der Schieber unten springt; oben: Inhalt (wenn das Buch eine Gliederung mitbringt), Lesezeichen (mehrere je Buch), Zitat (die Seite als Text — kopieren mit Quelle oder als Schnipsel) und Einstellungen.', 'Einstellungen bleiben am Gerät, weil Helligkeit Gerätesache ist: Helligkeit, Wärme, Nacht (Seiten invertiert), Doppelseite (wie es passt / immer / nie — auf dem iPad quer zwei Seiten, am Handy eine), Größe (ganze Seite / volle Breite), Blättern mit oder ohne Bewegung. Seite, Lesezeichen und Stapel reisen mit.'] },
      { t: 'Einrichten', p: ['Das Schieberegler-Symbol rechts oben: Holz (Ebenholz, Nussbaum, Kirsche, alte Eiche), Lampe, Leuchter an/aus, ob das Fenster auf den Klang hört, ob eigene Zeilen auf der Platte liegen, und wie viel Unordnung.'] }
    ]
  },
  {
  ...
  },
  {
    ...
    abschnitte: [
      ...
      { t: 'Suchen & Ersetzen', p: ['Im offenen Text (Strg/⌘ + F): ein Suchwort, ein Ersatz, die Anzahl der Treffer. Mit ‹ und › — oder Enter und Umschalt+Enter — springe ich von Fundstelle zu Fundstelle; darüber steht, die wievielte von wie vielen gerade dran ist, und die Stelle wird kurz markiert. Am Ende geht es wieder von vorn los.', 'Vor dem Ersetzen wird der alte Stand eingefroren — nichts geht verloren. In formatiertem Text bleiben fett, kursiv, Farben und Überschriften stehen; nur die Wörter werden getauscht. Ein Wort, das quer durch eine Auszeichnung läuft („Wa“ fett, „ld“ normal), lässt sich nicht tauschen, ohne sie zu zerschneiden — VANI sagt, wie viele das betrifft, statt sie stillschweigend mitzuzählen.'] },
  ...
  },
  {
    ...
    abschnitte: [
      ...
      { t: 'Der Umschlag', p: ['Das Atelier ist ein Fenster: links der Deckel groß und immer im Blick, rechts die Felder zum Scrollen (auf dem Handy untereinander). Der kleine Deckel oben links im Heft (oder lange halten → „Umschlag & Papier gestalten“) öffnet das Atelier mit großer Vorschau. Stoff: Leinen, Leder, Kraftpapier, Samt, Marmor, Glatt. Farben: Grundton, Zweitton, Band. Muster. Etikett: Schild, Tesastreifen, Handschrift, Prägung — und die Schrift dazu. Ecken (rund, eckig, Metallecken), Gummiband in eigener Farbe, „Abgegriffen“ als Regler für Kanten, die schon viel erlebt haben. Der Seitenblock an der Kante wächst mit den Seiten.', 'Aufkleben & kritzeln: Sticker aus der Kiste (und mein „Schmu!“) aufs Cover, oder direkt aufs Cover kritzeln. Auf der Vorschau ziehen verschiebt, lange halten dreht, vergrößert oder macht ab. „Würfeln“ schlägt einen ganzen Look vor.'], b: 'Dunkles Leder, Metallecken, ein rotes Gummiband, Prägung als Etikett — und quer drüber ein Schmu!-Sticker.' },
      { t: 'Tisch und Regal einrichten', p: ['In Regal und Tisch gibt es oben das Schieberegler-Symbol: Platte und Bretter (Eiche, Nussbaum, Leder, Leinen, Dunkel), Größe der Hefte (klein, mittel, groß), Reihenfolge (zuletzt benutzt, A–Z, nach Farbe) und „Unordnung“ — ob die Hefte leicht verdreht liegen. Jede Wahl zeigt sich sofort hinter dem Fenster.'] },
      { t: 'Karten, Regal, Tisch', p: ['Die Hefteübersicht hat drei Ansichten (oben im Kopf): Karten (die Deckel in Reihen), Regal (ein echtes Bücherregal: die Hefte stehen mit dem Rücken nach vorn auf Brettern, unterschiedlich hoch und dick; was ich ins Regal gestellt habe, steht ein Brett tiefer) und Tisch (die Hefte liegen verstreut auf einer Holzplatte, leicht gedreht, das Weggestellte als Stapel). „Ins Regal stellen“ und „Zurück auf den Tisch“ sind animiert: das Heft gleitet wirklich hinüber. Antippen zieht es kurz heraus und schlägt es auf.'] },
      ...
      { t: 'Pfeile', p: ['Ein gerader Strich mit einem Haken am Ende — kurz stehen bleiben — wird ein Pfeil mit sauberer Spitze. Für Verbindungen, Verweise, „hier weiter“.'] },
      { t: 'Lasso und Formen', p: ['Das Lasso-Symbol in der Kritzelleiste: eine Schlinge um Striche ziehen — sie sind ausgewählt (gestrichelter Rahmen). Dann anfassen und verschieben, mit dem Kreuz löschen, mit dem Farbknopf in die aktuelle Stiftfarbe umfärben, Haken hebt die Auswahl auf. Das geht auch nach Tagen noch, weil VANI Striche als Punktfolgen speichert, nicht als Bild.', 'Formen: Bleibt der Stift am Ende eines Strichs einen halben Atemzug stehen, wird der Strich zur Form — eine gerade Linie, eine Ellipse, ein Rechteck. Was keine Form ist, bleibt Handschrift.'], b: 'Schnell einen Kreis um ein Wort ziehen, kurz stehen bleiben — ein sauberer Kreis. Später mit dem Lasso ein Stück nach rechts rücken.' },
      { t: 'Tonnotiz', p: ['Das Mikrofon in den Seitenwerkzeugen nimmt auf (bis fünf Minuten, mit Pegel und Uhr). Die Aufnahme liegt dann als kleine Kassette auf der Seite: antippen spielt ab, noch einmal hält an. Lange halten: Beschriften, drehen, abmachen. Sie reist mit Sicherung und Sync wie ein Foto.'], b: 'Den Tonfall einer Figur einsprechen, bevor ich ihn vergesse — direkt neben der Szene.' },
      { t: 'Reiter', p: ['Im Seitenmenü „Farbigen Reiter anheften“: Farbe wählen, ein Wort draufschreiben. Alle Reiter eines Hefts stehen als farbige Zungen unter dem Titel und springen zu ihrer Seite — in jeder Ansicht. Mehrere Reiter je Heft, das Lesezeichen (wo das Heft aufgeht) bleibt eigenständig.'] },
      { t: 'Gliederung', p: ['Sobald eine Seite eine Überschrift hat (Ü in der Formatleiste), erscheint oben das Gliederungs-Symbol: alle Überschriften aller Seiten, eingerückt nach Ebene. Antippen springt zur Seite und scrollt zur Überschrift. Projekte haben dasselbe: Kapitel → Szenen → Überschriften in den Szenen.'] },
      { t: 'Papiervorlagen', p: ['Neben Liniert, Kariert, Punkten und Blanko: Cornell (schmale Randspalte für Stichworte, unten ein Feld für die Zusammenfassung), Storyboard (sechs Felder) und Dialogblatt (zwei Spalten — links die eine Stimme, rechts die andere). Im Heft-Atelier unter „Papier“.'] },
      { t: 'Kritzeln', p: [
  ...
  },
  {
    ...
    abschnitte: [
      { t: 'Aufschlagen', p: ['Im Raum liegt das Buch. Ein Tippen, und es klappt auf. Zuerst kommt das Titelblatt: was darin steht, wie viele Figuren, wie viele Einträge — und rechts das Verzeichnis, in dem ein Tipp auf einen Namen sofort zu ihr springt.', 'Geblättert wird mit den Pfeilen unten, mit den Pfeiltasten, oder indem du quer über die Seite wischst. Springst du weiter, fliegen mehrere Blätter — wie wenn man den Daumen durchlaufen lässt. An den Aussenkanten siehst du, wie dick der Stapel links und rechts noch ist.'] },
      { t: 'Das Lesebändchen', p: ['Unten neben der Seitenzahl hängt ein kleines Band. Ein Tipp, und es liegt bei dieser Figur; noch einer, und es ist wieder heraus. Beim nächsten Aufschlagen liegt das Buch dort. Gemerkt wird die Figur, nicht die Seitenzahl — sortierst du das Buch um, liegt das Band trotzdem bei ihr. Mit der Taste „b“.'] },
      ...
      { t: 'Was du eintragen kannst', p: ['Sieben Gruppen: Der Kopf der Seite (Spitzname, Alter, geboren, gestorben, Orte), Wie sie aussieht (von Statur und Händen bis Narben, Geruch und was in den Taschen ist), Was für ein Mensch das ist (Wesenszüge, der Widerspruch, Eigenheiten, Ängste, die Lüge über sich selbst, will und braucht), Was geschehen ist (Ereignisse, Wendepunkt, Familie), Wie sie klingt (Sätze, die erste Zeile, was sie nie sagt) und Wo sie hingehört (Geschichten, Rolle, Ort, Klang) — und An den Rand geschrieben (Leitsatz und Notizen). Dazu eigene Kategorien, so viele du willst.'] },
      ...
      { t: 'Geburtstag und Todestag', p: ['Schreib das Datum so, wie du es sagst: „9.4.1783“, „9. April 1783“, „April 1783“ — oder nur „1783“. VANI liest das und zeigt dir gleich darunter, was es verstanden hat. Auch „Maerz“ ohne Umlaut geht, und zweistellige Jahre („1. Mai 26“).', 'Steht ein Datum da, steht es sofort auch im Kalender — und rechnet dort das Alter mit. Änderst du es, ändert sich der Kalendereintrag; nimmst du es weg, verschwindet er.', 'Der Kalender reicht von 1600 bis 2050. Eine Figur, die 1783 geboren wurde, kannst du also eintragen; oben auf der Seite steht dann „✻ 9. Apr 1783 † 9. Apr 1845 — wurde 62 Jahre alt“.'] },
      ...
      { t: 'Klebezettel', p: ['Bis zu fünfzehn pro Figur, in fünf Farben. Sie kleben links unten auf der Doppelseite, ordentlich nebeneinander — dort haben sie Platz, und die linke Seite bekommt das Gewicht.'] },
      { t: 'Suchen und finden', p: ['Oben liegt die Suchleiste — sie sucht zuerst im Namen, dann in allem anderen. Daneben das Register: ein Buchstabe, ein Sprung.'] },
      { t: 'In welcher Ordnung', p: ['Alphabetisch ist die Ruhelage, und sie bleibt es: so liegt jede Figur immer an derselben Stelle. Der Knopf oben schaltet für einen Moment um — nach Fülle, die Stillen zuerst, zuletzt angefasst, nach Anlage, nach Geburtstag. Solange eine andere Ordnung gilt, steht sie sichtbar oben, damit du weisst, warum die Seiten woanders liegen.'] },
      { t: 'Eine Geschichte allein', p: ['Was du bei „Kommt vor in“ einträgst, wird gezählt. Der Knopf daneben zeigt dann nur noch die Figuren einer Geschichte — oder du tippst direkt auf den Namen der Geschichte auf der Seite. „Filter weg“ holt alle zurück.'] },
      { t: 'Das Bildnis', p: ['Standardmässig ist es aus. Ein Gesicht festzulegen nimmt einem etwas weg: solange keins dasteht, darf die Figur aussehen, wie sie im Kopf gerade aussieht. Statt eines Bildes liegt ein grosser, blasser Anfangsbuchstabe im Papier.', 'Wer eins will, schaltet es in den Feinheiten unter „Album“ ein. Dann hängt auf der linken Seite ein gerahmtes Bildnis: ein Foto vom Gerät, oder selbst gezeichnet.'] },
      ...
      { t: 'Das Netz', p: ['Der Knopf „Netz“ legt alle Figuren auf einen Kreis und zieht Linien dazwischen: Familie, Nähe, Bewunderung, Verachtung. Ein Tipp auf einen Punkt schlägt die Figur auf. Wer keine Linie hat, steht aussen allein — das ist kein Fehler, aber oft ein Hinweis. Darunter meldet das Netz Paare, die sich auffällig ähneln.'] },
      { t: 'Zwei nebeneinander', p: ['„Zwei vergleichen“ legt zwei Figuren Feld für Feld nebeneinander. Was wortgleich ist, wird markiert. Nicht um zu bewerten, sondern um zu sehen, wo zwei einander zu ähnlich geraten sind.'] },
      { t: 'Abschreiben', p: ['Im Blatt zur Figur nimmt „Abschreiben“ alles mit in eine neue Figur — für Geschwister, Zwillinge, dieselbe Figur zehn Jahre später. Nur Geburts- und Todestag bleiben leer: die stehen im Kalender, und zwei Einträge für jemanden, den es so gar nicht gibt, wären dort ein Ärgernis.'] },
      { t: 'Eine Frage', p: ['Unten rechts steht eine Frage an die Figur — „Was würde sie nie zugeben, obwohl es stimmt?“ Kein Feld, keine Pflicht. Der Pfeil dreht auf eine andere; „antworten“ klebt deine Antwort als Zettel auf die linke Seite. Dieselbe Figur bekommt beim Aufschlagen immer dieselbe Frage, bis du weiterdrehst.'] },
      ...
      { t: 'Tasten', p: ['Pfeile links und rechts blättern, Bild auf und ab ebenso, Pos1 springt aufs Titelblatt und Ende ans Ende. „n“ legt eine neue Figur an, „z“ schlägt irgendeine auf, „b“ legt das Lesebändchen hinein oder nimmt es heraus.'] }
    ]
  },
  {
    id: 'kabinett', titel: 'Das Kabinett', icon: 'kabinett', raum: 'kabinett',
    kurz: 'Ein Schrank mit Fächern. Was darin liegt, geht vollflächig auf.',
    abschnitte: [
      { t: 'Wozu ein Schrank', p: ['Manche Werkzeuge sind groß gedacht wie das Album oder der Schreibtisch — aber man braucht sie selten. In der Leiste nähmen sie Platz weg, den sie nicht verdienen. Also liegen sie in Fächern. Ein Tippen, und das Werkzeug geht über die ganze Fläche auf, mit eigener Leiste und einem Rücken-Knopf. Es verhält sich wie ein eigener Raum, ohne einer zu sein.'] },
      { t: 'Was darin liegt', p: ['Der Wandteppich — Stammbäume, die auch die Fäden kennen, die keine Familie sind. Und der Kartentisch — Stadtpläne für Orte, die es nur bei dir gibt.'] },

      { t: 'Der Kartentisch', p: ['Eine Stadt zeichnet man nicht Haus für Haus. Du sagst, WO sie liegt (am Fluss, am Meer, an einem See, auf einer Insel), WIE ALT sie ist und WIE GROSS — und Gassen, Blöcke und Häuser wachsen daraus. Danach gehst du hinein und gibst den Stellen Namen, die dir wichtig sind.'], b: 'Das Papier liegt auf dunklem Holz, Messingbeschwerer halten die Ecken. Es ist keine Datei, es ist ein Blatt.' },
      { t: 'Die Saat', p: ['Aus ihr wird jede Gasse gerechnet. Dieselbe Saat ergibt bis auf den letzten Dachfirst dieselbe Stadt — heute, morgen, auf jedem Gerät. Gespeichert wird deshalb nur die Saat und was du selbst hineingeschrieben hast: ein Plan mit vierhundert Häusern wiegt so viel wie ein kurzer Brief.', 'Gefällt dir eine Stadt nicht, würfelst du eine neue Saat — die Vorschau zeigt sofort, was daraus wird. Gefällt sie dir, rühr sie nie wieder an.'] },
      { t: 'Wie sie angelegt ist', p: ['Drei Arten, und das ist keine Verzierung — es entscheidet, was für ein Ort das ist.', 'GEWACHSEN: niemand hat sie geplant. Straßen gehen vom Markt fort, biegen sich, treffen einander wieder; was dazwischen eingeschlossen bleibt, ist ein Block — und der ist selten viereckig.', 'STRAHLEND: ein Fürst hat einen Punkt gesetzt und alles darauf ausgerichtet. Straßen sternförmig, Ringe darum. So sind Karlsruhe und Palmanova gebaut.', 'SCHACHBRETT: ein Ingenieur, ein Lineal, ein Auftrag. Gerade Achsen, gleiche Blöcke, zwei Prachtdiagonalen quer hindurch. Jede Römerstadt, jede Kolonie.'] },
      { t: 'Wie alt sie ist', p: ['Das entscheidet über die Form. UR ALT heißt: krumme Gassen, die niemand geplant hat, ungleiche Blöcke, Straßen, die mittendrin anfangen. AM REISSBRETT heißt: gerade Achsen, klare Blöcke, jemand hat das entworfen und durchgesetzt. Dazwischen liegt alles andere.'] },
      { t: 'Was von allein entsteht', p: ['Ein Marktplatz in der Mitte, Ringstraßen und Ausfallstraßen, eine Stadtmauer mit Türmen und benannten Toren, eine Vorstadt davor, eine Burg, Brücken über den Fluss, eine Kirche, ein Friedhof, Gärten — und draußen Felder, Wälder, Hügel und einzelne Höfe. Auf dem Wasser fährt ein Segler, und wo das Meer weit wird, liegt etwas darin.'] },
      { t: 'Die Viertel', p: ['Die Stadt teilt sich in Viertel, und jedes hat einen Charakter: Handwerk, wohlhabend, arm, geistlich, am Hafen. Der Charakter entscheidet, wie eng gebaut wird und wie groß die Häuser sind — im armen Viertel steht Haus an Haus, im wohlhabenden gibt es Höfe und Bäume.'] },
      { t: 'Marken setzen', p: ['Nimm oben das Marken-Werkzeug, wähl ein Zeichen und tipp auf die Karte. Achtundzwanzig Zeichen, alle geritzt: Kirche, Burg, Turm, Tor, Brücke, Mühle, Ruine, Markt, Brunnen, Friedhof, Hafen, Wirtshaus, Schmiede, Bäckerei, Bücherei — und Dunkles: Galgen, Kerker, Grab, „Hier geschah es“.', 'Eine Marke lässt sich verschieben. Ein Tippen nimmt sie in den Blick: dann liegt unten links eine Karte mit allem, was daran hängt — und was in der Nähe ist, samt Fußweg dorthin.'] },
      { t: 'Wer wohnt hier', p: ['Eine Marke lässt sich mit einer Figur aus dem Album verbinden. Danach führt ein Tippen von der Karte direkt auf ihre Doppelseite im Album — und du weißt immer, wo sie wohnt.'] },
      { t: 'Wie weit ist es', p: ['Das Mess-Werkzeug: zwei Stellen antippen, und VANI sagt, wie viele Schritt es sind und wie lange man geht — gemächlich, eilig, zu Pferd. Gerechnet über die Luftlinie mal einem Umwegfaktor, denn durch Gassen läuft niemand geradeaus.'], b: 'Die nützlichste Zahl auf der ganzen Karte: „Von der Schmiede zum Hafen sind es zwölf Minuten“ — das entscheidet, ob eine Szene funktioniert.' },
      { t: 'Namen', p: ['Gassen, Ringe und Viertel bekommen von allein deutsche Namen: Krummgasse, Salzstraße, Rabenwinkel, Das Nebelviertel. Gefällt dir einer nicht, benenn ihn im Verzeichnis um — dein Name schlägt den gerechneten und bleibt.'] },
      { t: 'Das Verzeichnis', p: ['Alle Marken nach Gruppen, alle Straßen, alle Viertel — und was auffallt: eine Marke im Wasser, zwei mit demselben Namen, zu viele ohne. Von dort springt ein Tippen an die Stelle auf der Karte.'] },
      { t: 'Als Blatt ablegen', p: ['Eine Karte ist ein Bild; zum Schreiben braucht man Sätze. Der Knopf legt die ganze Stadt als Text bei den Blättern ab: Lage, Größe, Viertel, Straßen, alles was einen Namen hat — und die Saat, damit die Karte wieder auffindbar ist.'] },
      { t: 'Aussehen', p: ['Sechs Farbwelten (Tinte und Bütten, Moos und Kupfer, Rost und Sand, Seekarte, Nacht und Laternen, Winter), sechs Papiere und fünf Zuschnitte — das ganze Blatt, ein Kreis, ein Oval, ein Bogen, ein Achteck. Das Papier altert mit: Stockflecken, Faltlinien, dunklere Ecken.'] },
      { t: 'Tasten am Kartentisch', p: ['1 die Hand, 2 die Marke, 3 das Messband. Plus und Minus zoomen, 0 setzt zurück, „n“ blendet die Namen aus, „v“ öffnet das Verzeichnis, Esc lässt los.'] },


      { t: 'Der Wandteppich', p: ['Ein Stammbaum — aber einer, der auch die Fäden kennt, die keine Familie sind. Auf grünem Tuch steigen helle Äste auf, an jedem hängt ein Band mit einem Namen. Keine Bilder: ein Name, die Jahre, und wenn du magst ein geritztes Zeichen daneben.'] },
      { t: 'Namen aufhängen', p: ['„+ Name" hängt einen auf. Oder hol sie aus dem Album: im Verzeichnis „Aus dem Album holen" — dann folgt das Band dem Album, und wer dort umbenannt wird, heißt hier mit. Umgekehrt geht es auch: in der Kartusche „Ins Album übernehmen".'] },
      { t: 'Zwei Werkzeuge', p: ['Oben in der Leiste: die HAND und der FADEN. Mit der Hand schaust du und schiebst Namen; mit dem Faden ziehst du einfach von einem Namen zum anderen — dann geht das Fenster schon mit beiden Enden auf, und du wählst nur noch die Art. Tasten 1 und 2.'] },
      { t: 'Eine Person in den Blick nehmen', p: ['Ein Tipp auf ein Namensband nimmt die Person in den Blick: ihre Fäden treten hervor, alle anderen treten zurück, und unten links erscheint eine Karte mit allem, was an ihr hängt — jeder Faden anklickbar. Noch ein Tipp, und die Kartusche geht auf. Auf das leere Tuch tippen (oder Esc) lässt wieder los.'], b: 'Bei dreißig Fäden auf einer Wand ist das der schnellste Weg zu der Frage: Was hat dieser Mensch eigentlich mit den anderen zu tun?' },
      { t: 'Fäden spinnen', p: ['Das Herz der Sache. In der Kartusche „+ Einen Faden spinnen": erst die Art, dann wen es betrifft, dann ein Wort dazu. Fünf Gruppen — Blut, Bund, Herz, Klinge, Band —, dreißig Arten darin, von „Kind von" über „ist verliebt in" bis „war schuld an" und „weiß nichts von". Unter dem Fenster steht immer der fertige Satz, damit die Richtung stimmt.'] },
      { t: 'Blut baut den Baum', p: ['Nur die Blutfäden entscheiden, wer wo hängt: „Kind von", „Aufgezogen von", „Uneheliches Kind von". Ehe und Bund legen zwei nebeneinander. Alles andere wird als Ranke über den Baum gespannt — farbig, geschwungen, mit einem Knoten dort, wo sie ausgeht, und einem Pfeil dort, wo sie ankommt.'], b: 'Deshalb bleibt es ein Stammbaum und wird keine Wolke aus Strichen: das Gerüst ist ruhig, die Ranken liegen darüber.' },
      { t: 'Sechzig Fadenarten', p: ['In sechs Gruppen: Blut (wer von wem abstammt), Bund (wer mit wem zusammensteht), Herz (was zwischen zweien ist, ob sie es wissen oder nicht), Klinge (was einer dem anderen angetan hat), Band (alles andere) und Schicksal — was über zweien liegt, ohne dass einer es gewählt hätte: Flüche, Weissagungen, Wiedergänger, Träume.'] },
      { t: 'Wenn es zu viel wird', p: ['Oben unter der Leiste steht jede benutzte Fadenart mit ihrer Anzahl. Ein Tipp darauf, und diese Fäden verschwinden vom Tuch — der Baum bleibt. So schaust du dir erst nur an, wer wen liebt, dann nur, wer wem etwas angetan hat.'] },
      { t: 'Eigene Fadenarten', p: ['Reicht die Auswahl nicht — und sie reicht irgendwann nie —, leg eine eigene an: Name, wie sie sich liest ({a} und {b} werden durch die Namen ersetzt), wofür sie da ist, Richtung, Farbe (auch jede beliebige) und eines von sechs Strichbildern. Darunter siehst du sofort, wie der Faden aussehen und sich lesen wird.'] },
      { t: 'Nur hier — oder überall', p: ['Beim Anlegen entscheidest du, wohin die Art gehört: NUR DIESER TEPPICH (etwas, das es nur in dieser Geschichte gibt) oder DIE BIBLIOTHEK (dann steht sie in jedem Stammbaum zur Auswahl, auch in denen, die du erst noch webst).', 'In der Auswahl steht ein ◆ für die Bibliothek und ein ◇ für „nur dieser Teppich“. Verwalten lässt sich die Bibliothek unter „Der Rahmen“.'], b: 'Nur Blut lässt sich nicht erfinden — daran hängt der Bau des Baumes.' },
      { t: 'Die Legende', p: ['Unter der Leiste steht jede benutzte Fadenart, nach Gruppen gebündelt. Ein Tipp schaltet eine Art stumm, ein Tipp auf den Gruppennamen die ganze Gruppe, und „nur“ blendet alles andere aus. So schaust du dir erst nur an, wer wen liebt, dann nur, wer wem etwas angetan hat.'] },
      { t: 'Von Hand nachhelfen', p: ['Gerechnet ist gut, aber manchmal weißt du es besser. Zieh ein Namensband einfach an eine andere Stelle — es rastet in einem groben Raster ein und bleibt dort liegen, während sich alle anderen weiter von selbst darum herum ordnen.', 'Zurück geht es jederzeit: in der Kartusche „Wieder einordnen lassen" für einen einzelnen, oder oben in der Leiste der Rundpfeil für alle auf einmal. Der Pfeil erscheint nur, wenn wirklich jemand von Hand liegt.'] },
      { t: 'Ausbrennen', p: ['Wie in einem alten Wandteppich, aus dem jemand entfernt wurde: In der Kartusche „Aus dem Tuch brennen". Das Zeichen verschwindet in einem versengten Loch, der Name bleibt lesbar. Rückgängig geht es auch — dann schließt sich das Loch wieder.'] },
      { t: 'Was auffällt', p: ['Im Verzeichnis unter „Was auffällt": eine Abstammung im Kreis, ein Kind, das älter wäre als sein Vater, jemand, der nach seinem Tod noch getötet hat, Namen ganz ohne Faden. Nicht als Vorwurf — als Hinweis.'] },
      { t: 'Der Rahmen', p: ['Titel, der Spruch, der oben und unten am Rand entlangläuft, und das Tuch in sechs Farben. „Als Blatt ablegen" schreibt alle Namen und Fäden als Text zu den Blättern — damit ein Stammbaum nicht in einem Format gefangen ist, das nur VANI lesen kann.'] },
      { t: 'Leben auf dem Tuch', p: ['Das Laub wiegt sich, ab und zu löst sich ein Blatt und segelt hinunter, und manchmal huscht ein Eichhörnchen über einen Ast. Alles steht still, wenn das Fenster verdeckt ist oder du in den Feinheiten weniger Bewegung eingestellt hast.'] },
      { t: 'Tasten', p: ['Plus und Minus zoomen, 0 setzt zurück, das Doppelpfeil-Symbol passt alles ins Bild. „n" hängt einen Namen auf, „v" öffnet das Verzeichnis.'] }
    ]
  },
  {
  ...
  },
  {
    ...
    abschnitte: [
      { t: 'Abfragen (Karteikarten)', p: ['Neben dem Titel einer Kiste: „Abfragen“. Vorn steht das Wort, ein Tipp dreht die Karte, hinten steht die Notiz. Dann „Gewusst“ oder „Nochmal“ — was ich verfehle, kommt beim nächsten Mal zuerst, was sicher sitzt, seltener. „Rückwärts“ fragt von der Notiz zum Wort. Mit Tastatur: Leertaste dreht, Pfeil rechts gewusst, Pfeil links nochmal. Am Ende eine kleine Bilanz.'], b: 'Die Kiste „Wörter für Wetter“: zehn Karten, sieben gewusst — die drei anderen kommen morgen zuerst.' },
  ...
  },
  {
    ...
    abschnitte: [
      ...
      { t: 'Die Suche bringt dich hin', p: ['Ein Tipp auf einen Treffer öffnet den Text nicht nur — er springt an die Fundstelle, rückt sie in die Mitte und markiert das Wort für ein paar Sekunden. In einer langen Szene ist das der Unterschied zwischen „gefunden“ und „gefunden und da“. Beim nächsten normalen Öffnen springt nichts mehr.'], b: 'Ein Wort auf Seite vier einer Szene: Suche, Tipp — und es steht vor dir, statt dass du von oben scrollst.' },
      { t: 'Suchen im Projekt', p: ['Hat ein Projekt vier Szenen oder mehr, steht über den Kapiteln ein eigenes Feld. Es sucht in Szenentiteln, im Text und in deiner Notiz an der Szene und blendet alles andere aus — Kapitel ohne Treffer verschwinden gleich mit. Jede übrig gebliebene Karte sagt, warum: die Stelle im Text, „steht im Titel“ oder „steht in deiner Notiz“. Enter öffnet die erste und landet dort auf dem Wort, Esc räumt wieder auf.'] },
