...
const ANLEITUNG = [
  ...
  },
  {
    ...
    abschnitte: [
      ...
      { t: 'Die Lampe', p: ['Am Knauf der Zugschnur ziehen — sie dehnt sich mit, schnappt zurück und schaltet die Lampe an oder aus (ab etwa einem Drittel Zug). Ist sie aus, bleibt nur der Schein der Kerzen. Auf den Schirm tippen: heller oder dunkler in Stufen. Das Fenster weiß außerdem, wie spät es ist: Dämmerung am frühen Abend, tiefe Nacht, erstes Grau vor sechs, und ein grauer Tag — der Tisch bleibt ein Nachttisch, aber der Himmel lügt nicht. Und er kennt die Jahreszeit: Glühwürmchen im Sommer, fallende Blätter im Herbst, Schnee und kahle Bäume im Winter, Blüten im Frühling.'] },
