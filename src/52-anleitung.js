...
const ANLEITUNG = [
  ...
  },
  {
    ...
    abschnitte: [
      ...
      { t: 'Woher die Formatleiste kommt', p: ['Blätter und Szenen: im Schreibraum unter Einstellungen „Aa · Text formatieren". Heftseiten: der Knopf „Text formatieren" in den Seitenwerkzeugen oben rechts auf der Seite.'] },
      { t: 'Einfügen von anderswo', p: ['Eingefügter Text wird entschärft: Schrift, Farbe, Listen und Überschriften bleiben, fremde Skripte oder seltsame Reste nicht. Ist das Eingefügte länger als eine Heftseite, läuft es automatisch auf die nächsten Seiten weiter.'] }
    ]
  },
  {
  ...
  },
  {
    ...
    abschnitte: [
      ...
      { t: 'Hereinholen', s: ['Feinheiten → „Den Faden holen" → „Faden hereinholen".', 'Das Passwort eingeben (wort-wort-zahl-wort-wort).', 'Warten — dann öffnet sich der Faden, und der Raum steht ab jetzt in der Leiste.'], p: ['Das muss nur einmal je Gerät geschehen. Was schon da ist, wird nicht doppelt geholt.'] },
  ...
  },
  {
    ...
    abschnitte: [
      ...
      { t: 'Nur Texte kopieren', p: ['Legt alle Texte als einfachen Text in die Zwischenablage — Projekte mit Kapiteln, Hefte mit Seiten und Zetteln, Schnipsel mit Datum. Zum Einfügen irgendwo anders.'] },
      ...
      { t: 'Wenn das Gerät keine Dateien öffnen darf', p: ['Manche Schul-iPads lassen keine Dateiauswahl zu. Dann helfen: der Faden kommt ohnehin ohne Datei (mit Passwort), Texte gehen über Teilen und die Zwischenablage hinaus, und der Sync überträgt alles ohne Datei — siehe „Mehrere Geräte".'] }
    ]
  },
  {
  ...
  },
  {
    ...
    abschnitte: [
      { t: 'Der private Bereich', p: ['Ein Bereich ist mein verschlüsselter Stapel auf einem Sync-Dienst. Der Dienst sieht nur Geheimtext; den Schlüssel haben nur meine Geräte. Ohne Bereich bleibt jedes Gerät für sich — das ist der Standard.'] },
      { t: 'Anlegen', s: ['Feinheiten → „iPad ↔ Laptop ↔ weitere Geräte" → „Neuen privaten Bereich".', 'Einen Namen geben. Die Adresse des Dienstes ist vorausgefüllt.', 'Fertig — alles, was auf diesem Gerät liegt, nimmt der Bereich mit.'] },
  ...
  },
  {
    ...
    abschnitte: [
      { t: 'iPad und iPhone', s: ['Die VANI-Adresse in Safari öffnen.', 'Teilen-Symbol (Viereck mit Pfeil) → „Zum Home-Bildschirm".', 'Ab jetzt über das Icon starten — Vollbild, ohne Safari-Leiste, offline.'], p: ['Kein App Store nötig. Das geht auch auf einem Schul-iPad, solange Safari Webseiten öffnen darf.'] },
      { t: 'Android-Handy', s: ['Adresse in Chrome öffnen.', 'Menü (drei Punkte) → „Zum Startbildschirm hinzufügen" oder „App installieren".'] },
      { t: 'Windows-Laptop', p: ['Entweder die Adresse im Browser öffnen (Chrome, Edge: dort gibt es „App installieren" in der Adressleiste) — oder die Desktop-App: VANI-x64-Setup.exe installiert sie, VANI-x64-Portable.exe läuft ohne Installation.'] },
      { t: 'Updates hinter demselben Icon', p: ['Ein Icon genügt für immer. Solange die Adresse gleich bleibt, ersetzen neue Fassungen die App still hinter demselben Icon — ich muss nie wieder „Zum Home-Bildschirm" wählen. Beim Start holt VANI sich im Hintergrund die neue Fassung; unten erscheint dann „Eine neue Fassung liegt bereit → Neu laden". Oder: Feinheiten → „VANI jetzt aktualisieren".'], b: 'Am Laptop wurde etwas an VANI gebaut und veröffentlicht. Am iPad öffne ich VANI, tippe in den Feinheiten auf „VANI jetzt aktualisieren" — fertig. Meine Texte bleiben, wo sie sind.' },
