...
const ANLEITUNG = [
  ...
  },
  {
    ...
    abschnitte: [
      ...
      { t: 'Blut baut den Baum', p: ['Nur die Blutfäden entscheiden, wer wo hängt: „Kind von" und „Aufgezogen von". Ehe und Bund legen zwei nebeneinander. Alles andere wird als Ranke über den Baum gespannt — farbig, geschwungen, mit einem Pfeil am Ende, wenn der Faden eine Richtung hat.'], b: 'Deshalb bleibt es ein Stammbaum und wird keine Wolke aus Strichen: das Gerüst ist ruhig, die Ranken liegen darüber.' },
      ...
      { t: 'Eigene Fadenarten', p: ['Reicht die Auswahl nicht, leg eine eigene an: Name, wie sie sich liest ({a} und {b} werden durch die Namen ersetzt), Farbe und Strich. Sie gehört diesem Teppich und steht danach in der Auswahl wie jede andere. Nur Blut lässt sich nicht erfinden — daran hängt der Bau des Baumes.'] },
